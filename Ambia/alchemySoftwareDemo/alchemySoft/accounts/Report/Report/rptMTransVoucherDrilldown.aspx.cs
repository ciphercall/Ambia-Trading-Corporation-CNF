    ...
    public partial class rptMTransVoucherDrilldown : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                string VouchNo = HttpContext.Current.Server.UrlDecode(Request.QueryString["voucherno"]);
        ...
        {
            string TransType = HttpContext.Current.Server.UrlDecode(Request.QueryString["transtp"]);
            string TransDate = HttpContext.Current.Server.UrlDecode(Request.QueryString["date"]);
            string VouchNo = HttpContext.Current.Server.UrlDecode(Request.QueryString["voucherno"]);
            string MonYear = HttpContext.Current.Server.UrlDecode(Request.QueryString["transmy"]);
