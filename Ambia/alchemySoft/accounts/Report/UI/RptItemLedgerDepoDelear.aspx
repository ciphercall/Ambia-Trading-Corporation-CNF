<%@ Page Title="" Language="C#" MasterPageFile="~/alchemy.Master" AutoEventWireup="true" CodeBehind="RptItemLedgerDepoDelear.aspx.cs" Inherits="DynamicMenu.Accounts.Report.UI.RptItemLedgerDepoDelear" %>
    ...
    function Search_GetCompletionListLedgerBook() {
        $("#<%=txtHeadNM.ClientID %>").autocomplete({
                    source: function (request, response) {
                        $.ajax({
                            url: "../../../search.asmx/GetCompletionListLedgerBookDepoDelear",
                            type: "POST",
                            dataType: "json",
                            contentType: "application/json; charset=utf-8",
                            data: "{ 'txt' : '" + $("#<%=txtHeadNM.ClientID %>").val() + "'}",
    ...
    <div class="col-md-10 pull-right" id="mainContentBox">
        <div id="contentBox">
            <div id="contentHeaderBox">
                <h1>Ledger Book (Depot/Dealer)</h1>
          ...
          <div class="content_wrapper  col-md-12">
                <div class="row form-class">
                    ...
                    <div class="col-md-4">
                        <asp:TextBox ID="txtHeadNM" runat="server" AutoPostBack="True" CssClass="form-control input-sm"
