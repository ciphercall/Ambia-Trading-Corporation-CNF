<%@ Page Title="" Language="C#" MasterPageFile="~/alchemy.Master" AutoEventWireup="true" CodeBehind="MultipleVoucher.aspx.cs" Inherits="alchemy.accounts.UI.MultipleVoucher" %>
                ...
                <div id="contentBox">
                    <div id="contentHeaderBox">
                        ...
                        <!-- <span class="pull-right" id="editOption"><i class="fa fa-cog"></i></span> -->
                         ...
                         <%Session["UPDATER_Multiv"] = dbFunctions.checkParmit("/Accounts/UI/MultipleVoucher.aspx", "UPDATER");
                            Session["DELETER_Multiv"] = dbFunctions.checkParmit("/Accounts/UI/MultipleVoucher.aspx", "DELETER");
                            Session["INSERTR_Multiv"] = dbFunctions.checkParmit("/Accounts/UI/MultipleVoucher.aspx", "INSERTR"); %>
                    ...
                    <div class="content_wrapper  col-md-12"><br /><br />
                        ...
                        <div class="row form-class">
                            ...
                            <div class="col-md-2">
                                <asp:TextBox ID="txtVouchNo" Width="100%" runat="server" ReadOnly="True" CssClass="form-control input-sm"></asp:TextBox>
                                <asp:DropDownList ID="ddlVouch"  Width="100%" runat="server" AutoPostBack="True" OnSelectedIndexChanged="ddlVouch_SelectedIndexChanged"
                                    CssClass="form-control " Visible="False">
                                </asp:DropDownList>
                            </div> 
                            <div class="col-md-2"></div>
                            <div class="col-md-2">
                                <% if (Session["UPDATER_Multiv"].ToString()== "True")
                                    { %>
                                <asp:Button ID="btnEdit"  Width="100%" runat="server" CssClass="form-control btn-primary input-sm"
                                    Text="EDIT" OnClick="btnEdit_Click" />
                                <% } %>
                            </div>
                            <div class="col-md-2">
                                <asp:Button ID="btnPrint" runat="server" Width="100%" CssClass="form-control btn-primary input-sm"
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-2">
                                <asp:DropDownList ID="ddlTransType" runat="server"  Width="100%" OnSelectedIndexChanged="ddlTransType_SelectedIndexChanged"
                            ...
                            <div class="col-md-2">
                                <asp:TextBox ID="txtTransDate" runat="server"
                                    OnTextChanged="txtTransDate_TextChanged"  Width="100%" AutoPostBack="True" CssClass="form-control input-sm"></asp:TextBox>
                            </div>
                            <div class="col-md-2">
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField>
                                        <ItemTemplate>
                                            ...
                                            <% } %>
                                               <% if (Session["DELETER_Multiv"].ToString()== "True")
                                                { %>
                                        ...
                                        <FooterTemplate>
                                               <% if (Session["INSERTR_Multiv"].ToString()== "True")
                                                { %>
