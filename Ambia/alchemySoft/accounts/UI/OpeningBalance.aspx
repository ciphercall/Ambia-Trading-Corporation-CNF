<%@ Page Title="" Language="C#" MasterPageFile="~/alchemy.Master" AutoEventWireup="true" CodeBehind="OpeningBalance.aspx.cs" Inherits="alchemy.accounts.UI.OpeningBalance" %>
                    ...
                    <br />
                      <div class="content_wrapper  col-md-12">
                        ...
                        <div class="row form-class">
                            ...
                            <div class="col-md-4">
                                <asp:TextBox ID="txtDate" runat="server" Width="100%" CssClass="form-control input-sm"
                            ...
                            <asp:GridView ID="gvDetails" runat="server" BackColor="White" BorderStyle="None" CssClass="Gridview text-center" CellPadding="3"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Account Head">
                                        ...
                                        <EditItemTemplate>
                                            <asp:TextBox ID="txtDebitCDEdit"  Width="100%" runat="server" CssClass="form-control input-sm" Text='<%#Eval("ACCOUNTNM") %>' TabIndex="12" />
                                            <asp:TextBox ID="txtDebitCDCodeEdit"  Width="100%" style="display: none" runat="server" CssClass="form-control input-sm" Text='<%#Eval("ACCOUNTNM") %>' TabIndex="12" />
                                        </EditItemTemplate>
                                        <FooterTemplate>
                                            <asp:TextBox ID="txtDebitCD"  Width="100%" runat="server" CssClass="form-control input-sm" TabIndex="2" />
                                            <asp:TextBox ID="txtDebitCDCode"  Width="100%" style="display: none"  runat="server" CssClass="form-control input-sm" TabIndex="2" />
                                        </FooterTemplate>
                                    ...
                                    <asp:TemplateField HeaderText="Debit Amount">
                                        ...
                                        <EditItemTemplate>
                                            <asp:TextBox ID="txtDbAmtEdit"  Width="100%" CssClass="form-control input-sm" runat="server" Text='<%#Eval("DEBITAMT") %>'
                                                Style="text-align: right" TabIndex="13" />
                                        </EditItemTemplate>
                                        <FooterTemplate>
                                            <asp:TextBox ID="txtDbAmt"  Width="100%" CssClass="form-control input-sm" runat="server" TabIndex="3"
                                    ...
                                    <asp:TemplateField HeaderText="Credit Amount">
                                        ...
                                        <EditItemTemplate>
                                            <asp:TextBox ID="txtCrAmtEdit" Width="100%"  CssClass="form-control input-sm" runat="server" Text='<%#Eval("CREDITAMT") %>'
                                                Style="text-align: right" TabIndex="14" />
                                        </EditItemTemplate>

                                        <FooterTemplate>
                                            <asp:TextBox ID="txtCrAmt"  Width="100%" CssClass="form-control input-sm" runat="server" TabIndex="4"
                                                Style="text-align: right" />
                                        </FooterTemplate>
                                        <FooterStyle Width="15%" />
                                        <ItemStyle Width="15%" />
                                    ...
                                    <asp:TemplateField>
                                        ...
                                        <ItemTemplate>
                                            <% if (dbFunctions.checkParmit("/Accounts/UI/OpeningBalance.aspx", "UPDATER") == true)
                                                { %>
                                            <asp:ImageButton ID="imgbtnEdit" CommandName="Edit" runat="server"
                                                ImageUrl="~/Images/Edit.png" ToolTip="Edit" Height="20px" Width="20px"
                                                TabIndex="10" />
                                            <%} %>
                                            <% if (dbFunctions.checkParmit("/Accounts/UI/OpeningBalance.aspx", "DELETER") == true)
                                                { %>
                                        ...
                                        <FooterTemplate>
                                            <% if (dbFunctions.checkParmit("/Accounts/UI/OpeningBalance.aspx", "INSERTR") == true)
                                                { %>
