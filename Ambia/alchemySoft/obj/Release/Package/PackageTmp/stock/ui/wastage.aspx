<%@ Page Title="" Language="C#" MasterPageFile="~/alchemy.Master" AutoEventWireup="true" CodeBehind="wastage.aspx.cs" Inherits="alchemySoft.stock.ui.wastage" %>
                        ...
                        <div class="col-md-5">
                            <div class="col-md-12">
                                ...
                                <div class="row form-class3px">
                                    ...
                                    <div class="col-md-6">
                                        <asp:DropDownList ID="ddlTransMd" runat="server" Width="100%"
