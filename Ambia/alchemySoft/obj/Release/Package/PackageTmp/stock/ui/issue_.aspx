<%@ Page Title="" Language="C#" MasterPageFile="~/alchemy.Master" AutoEventWireup="true" CodeBehind="issue_.aspx.cs" Inherits="alchemySoft.stock.ui.issue_" %>
                    ...
                    <div class="content_wrapper  col-md-12">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="row form-class3px">
                                    ...
                                    <div class="col-md-8" style="margin-bottom: 2px">
                                        <asp:DropDownList ID="ddlStoreFr" runat="server" CssClass="select" Width="100%"></asp:DropDownList>
                                    </div>
                                </div>
                                <div class="row form-class3px">
                                    <div class="col-md-2">
                        ...
                        <div class="col-md-5">
                            <div class="col-md-12">
                                <br />
                                <br />
                                <asp:TextBox ID="txtBatch" runat="server" Width="100%"
                                    CssClass="form-control" Visible="false"></asp:TextBox>
                                <asp:TextBox ID="txtLot" runat="server" Width="100%"
                                    CssClass="form-control" Visible="false"></asp:TextBox>
                            </div>
                        </div>
                        <br />
                            ...
                            <asp:GridView ID="gvDetails" runat="server" CssClass="Grid" AutoGenerateColumns="False" ShowFooter="True"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Lot">
                                        ...
                                        <EditItemTemplate>
                                            <asp:DropDownList ID="ddlLotEdit" runat="server" CssClass="form-control input-sm" Width="100%">
                                            </asp:DropDownList>
                                        </EditItemTemplate>
                                        <FooterTemplate>
                                            <asp:DropDownList ID="ddlLotFooter" runat="server" CssClass="form-control input-sm" Width="100%">
                                            </asp:DropDownList>
                                        </FooterTemplate>
                                        <FooterStyle HorizontalAlign="Left" Width="10%" />
                                        <HeaderStyle HorizontalAlign="Center" Width="10%" />
