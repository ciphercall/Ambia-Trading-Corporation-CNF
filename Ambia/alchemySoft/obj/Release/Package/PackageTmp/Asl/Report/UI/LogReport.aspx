<%@ Page Title="" Language="C#" MasterPageFile="~/alchemy.Master" AutoEventWireup="true" CodeBehind="LogReport.aspx.cs" Inherits="alchemySoft.Asl.Report.UI.LogReport" %>
        ...
        <div id="contentBox">
            ...
            <div class="content_wrapper">
                <div class="col-md-12">
                    ...
                    <div class="row form-class">
                        <div class="col-md-2"></div>
                        <div class="col-md-2">Log Type</div>
                        <div class="col-md-4">
                            <asp:DropDownList runat="server" ID="ddlLogType" CssClass="form-control input-sm" />
                        </div>
                        <div class="col-md-4"></div>
                    </div>
                    <div class="row form-class">
